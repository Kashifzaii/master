...
import { FaInstagram, FaTwitter, FaLinkedinIn, FaSkype, FaPinterest } from 'react-icons/fa';
import '../globals.css';

export default function Footer() {
  return (
    <footer className="bg-[#2A254B] text-gray-500 py-12 w-[1340px] h-[380]">
      <div className="footer-container max-w-screen-xl mx-auto px-6 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Menu Section */}
          <div className="footer-section text-gray-500">
            <h3 className="footer-heading text-gray-500 font-semibold mb-4">Menu</h3>
            <ul className="w-[108] w-[175] top-[58px] left-[82]gap-[12] text-gray-500 footer-links space-y-2">
          ...
          {/* Categories Section */}
          <div className="footer-section w-[84px] h-[206p]">
            <h3 className="footer-heading text-xl font-semibold mb-4">Categories</h3>
            <ul className="footer-links text-gray-500 space-y-2">
